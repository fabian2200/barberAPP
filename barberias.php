...
<body class="">
              ...
              <div class="card-body all-icons">
                <div class="row">       
                  <div class="col-lg-12 text-center">
                    <a href="registrar_barberia.php" style="color: white;" class="btn btn-success"><h4 style="margin: 0;"><i class="fas fa-plus-circle"></i> Agregar Barberia</h4></a>
                  </div>
                </div>
                <hr>
  ...
  <script src="js/listar_barberias.js"></script>
</body>
</html>
<?php
}else{  
