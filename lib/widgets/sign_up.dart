...
class _SignUpState extends State<SignUp> {
  ...
  guardarUsuario(context) async{
    SweetAlertV2.show(context,subtitle: "Guardando datos...", style: SweetAlertV2Style.loading); 
    ...
    if(response.success == 1){
      ...
      SweetAlertV2.show(context,subtitle: response.mensaje, style: SweetAlertV2Style.error);
    } 
  }
