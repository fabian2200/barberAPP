...
import 'package:flutter_auth/http/login.dart';
...
class _SignInState extends State<SignIn> {
  ...
  login(context) async{
    if(usuario.text == "" || password.text == ""){
      SweetAlertV2.show(context,subtitle: "Ingrese un usuario y contraseña", style: SweetAlertV2Style.error);
    }else{
      SweetAlertV2.show(context,subtitle: "Validando datos...", style: SweetAlertV2Style.loading); 
      Login request = Login(usuario.text, password.text);
      dynamic response = await request.loguear();
      if(response["success"] == 1){
        String tipo = response["usuario"][0][4];
        if(tipo == "usuario"){
           new Future.delayed(
        ...
        SweetAlertV2.show(context,subtitle:  response["error"], style: SweetAlertV2Style.error);
      }  
    }
  }
